...
// ⚠️ この正規表現は kataToHira を **通したあと** の文字列に当てる。
//    そのためカタカナ語は必ずひらがな形も併記すること（「レシピ」だけ書くと
//    既に「れしぴ」になっていて永久にマッチしない。2026-07-31に修正）。
const DISH_NOISE =
  /(れしぴ|レシピ|の作り方|作り方|風|簡単|本格|絶品|激うま|やみつき|定番|基本の|お手軽|時短|超|究極の|プロの|our|recipe)/g;
